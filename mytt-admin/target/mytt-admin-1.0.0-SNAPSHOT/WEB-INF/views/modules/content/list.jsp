                        ...
                        <div class="box-header with-border">
                            <div class="box-header">
                                ...
                                <ul class="nav nav-pills pull-left">
                                    <li><a href="/content/form"><i class="fa fa-fw fa-plus text-primary"></i> 新增</a></li>
                                    <li onclick="Myshop.editInfo('/content/form')"><a href="javascript:void(0)"><i class="fa fa-fw fa-edit text-info"></i> 编辑</a></li>
                                    <li onclick="Myshop.initDelete('/content/del','温馨提示','确定删除已选数据吗？')"><a href="javascript:void(0)"><i class="fa fa-fw fa-trash text-danger"></i> 删除</a></li>
                                </ul>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                       <%-- <div class="form-horizontal">--%>
                            <div class="box-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-2">
                                        <input name="tagInfo" type="text" class="form-control" placeholder="关键字">
                                    </div>
...
<script>
    ...
    $(function () {
        ...
        var dataTable = Myshop.initDataTables("/content/data",
            [
                {
                ...
                {
                    data: function (row, type, set, meta) {
                        return "<a href='javascript:void(0)' class='btn btn-sm btn-default' onclick='Myshop.selectInfo(\"/content/detail?id=\"+"+row.id+",\"内容信息\")'><i class='fa fa-fw fa-search' title='查看'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;" +
                            "<a href='/content/form?id=" + row.id + "' class='btn btn-sm btn-info'><i class='fa fa-fw fa-edit' title='编辑'></i></a>&nbsp;&nbsp;&nbsp;&nbsp;" +
                            "<a href='javascript:void(0)' onclick='Myshop.initDelete(\"/content/del?ids=\"+"+row.id+",\"温馨提示\",\"确定要删除该笔数据吗？\")' class='btn btn-sm btn-danger'><i class='fa fa-fw fa-trash-o' title='删除'></i></a>";
                    }
                }
            ]);
