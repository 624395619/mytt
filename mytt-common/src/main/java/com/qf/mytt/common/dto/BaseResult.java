package com.qf.mytt.common.dto;

import com.qf.mytt.common.contants.HttpStatusConstant;
import lombok.Data;
...
public class BaseResult implements Serializable {
    ...
    public static BaseResult fail(String message) {
        BaseResult baseResult = createResult(HttpStatusConstant.HTTP_500, null,message , 0);
        Error error = createError(HttpStatusConstant.HTTP_500_CODE,message);
        baseResult.setError(error);
        return baseResult;
    }
